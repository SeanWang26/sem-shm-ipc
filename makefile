...
libjfront.so:usersdk.cpp frontdevice.cpp
	$(CCC) -m32 -fPIC -Wl,-rpath,./ -Wall -shared -o libjfront.so usersdk.cpp frontdevice.cpp jtprintf.c -L./ -ldl
...
plugtest.exe:plugtest.cpp
	$(CCC) -m32 -Wall -Wl,-rpath,./ -o plugtest.exe plugtest.cpp -L./ -ljfront -ljtxm -lxmnetsdk -lrt -lpthread
